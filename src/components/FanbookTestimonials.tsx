            ...
            <div className="relative bg-gradient-to-br from-blue-500 via-purple-600 to-pink-600 rounded-3xl overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-500">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white p-8">
                  <h3 className="text-3xl font-bold mb-3 bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">
                    Travel the world like
                  </h3>
                  <div className="text-5xl font-black text-yellow-400 mb-8 animate-pulse">NEERAJ</div>
                  <a
                    href="https://www.youtube.com/@himalayanape01/shorts"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold rounded-full transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
                  >
          ...
          <div className="relative order-1 lg:order-2">
            <div className="mb-10">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-pink-500 italic">Testimonials</h3>
                </div>
              </div>
            ...
            <div className="relative h-80 mb-10">
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-xl hover:scale-125 transition-all duration-300 bg-gradient-to-br from-purple-200 to-pink-200">
                        <img
                      ...
                      {/* Tooltip */}
                      <div className="absolute -top-16 left-1/2 transform -translate-x-1/2 bg-black/80 text-white px-3 py-2 rounded-lg text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
              ...
              {mainTestimonial && (
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 group">
                  <div className="relative">
                    <div className="w-40 h-40 rounded-full overflow-hidden border-6 border-gradient-to-r from-purple-500 to-pink-500 shadow-2xl hover:scale-110 transition-all duration-500 bg-gradient-to-br from-purple-100 to-pink-100">
                      <img
            ...
            {mainTestimonial && (
              <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-purple-100">
                <Quote className="w-8 h-8 text-purple-500 mx-auto mb-4" />
                <p className="text-gray-800 text-xl italic mb-6 leading-relaxed">
            ...
            <div className="text-center mt-10">
              <button className="inline-flex items-center px-10 py-4 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
                <span className="mr-2">💝</span>
